...
function (e, t) {
  ...
  }), p.fn[f] = w._jQueryInterface, p.fn[f].Constructor = w, p.fn[f].noConflict = function () {
  ...
  var E = "carousel",
    ...
    H = function () {
      ...
      return e.next = function () {
        ...
        p(this._element).off(x), p.removeData(this._element, T), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
        ...
        if (r = e === N ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", i = "carousel-item-prev", "right"), l && p(l).hasClass(O)) this._isSliding = !1;
          ...
          } else p(s).removeClass(O), p(l).addClass(O), this._isSliding = !1, p(this._element).trigger(f);
          c && this.cycle()
        }
  ...
  p(document).on(k.CLICK_DATA_API, "[data-slide], [data-slide-to]", H._dataApiClickHandler), p(window).on(k.LOAD_DATA_API, function () {
    for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, n = e.length; t < n; t++) {
      var i = p(e[t]);
      H._jQueryInterface.call(i, i.data())
    }
  }), p.fn[E] = H._jQueryInterface, p.fn[E].Constructor = H, p.fn[E].noConflict = function () {
    ...
    z = function () {
      ...
      return e.toggle = function () {
        ...
        if (!(this._isTransitioning || p(this._element).hasClass(U) || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (e) {
            return "string" == typeof n._config.parent ? e.getAttribute("data-parent") === n._config.parent : e.classList.contains(K)
          ...
          if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
            ...
            p(this._element).removeClass(K).addClass($), this._element.style[r] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(Q).attr("aria-expanded", !0), this.setTransitioning(!0);
            var o = "scroll" + (r[0].toUpperCase() + r.slice(1)),
              s = g.getTransitionDurationFromElement(this._element);
            p(this._element).one(g.TRANSITION_END, function () {
              p(n._element).removeClass($).addClass(K).addClass(U), n._element.style[r] = "", n.setTransitioning(!1), p(n._element).trigger(B.SHOWN)
        ...
        if (!this._isTransitioning && p(this._element).hasClass(U)) {
          ...
          if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
            ...
            this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", g.reflow(this._element), p(this._element).addClass($).removeClass(K).removeClass(U);
            var i = this._triggerArray.length;
            if (0 < i)
              for (var r = 0; r < i; r++) {
                var o = this._triggerArray[r],
                  s = g.getSelectorFromElement(o);
                null !== s && (p([].slice.call(document.querySelectorAll(s))).hasClass(U) || p(o).addClass(Q).attr("aria-expanded", !1))
              }
            this.setTransitioning(!0), this._element.style[n] = "";
            var a = g.getTransitionDurationFromElement(this._element);
            p(this._element).one(g.TRANSITION_END, function () {
              e.setTransitioning(!1), p(e._element).removeClass($).addClass(K).trigger(B.HIDDEN)
        ...
        return (e = l({}, F, e)).toggle = Boolean(e.toggle), g.typeCheckConfig(P, e, W), e
  ...
  }), p.fn[P] = z._jQueryInterface, p.fn[P].Constructor = z, p.fn[P].noConflict = function () {
    return p.fn[P] = M, z._jQueryInterface
  };
  for (var Y = "undefined" != typeof window && "undefined" != typeof document, X = ["Edge", "Trident", "Firefox"], G = 0, J = 0; J < X.length; J += 1)
    if (Y && 0 <= navigator.userAgent.indexOf(X[J])) {
      G = 1;
      break
    } var Z = Y && window.Promise ? function (e) {
    var t = !1;
    return function () {
  ...
  function Se(e, t, n) {
    ...
    var i = xe(e),
      ...
      l = o ? "height" : "width",
      u = o ? "width" : "height";
    return r[s] = t[s] + t[l] / 2 - i[l] / 2, r[a] = n === a ? t[a] - i[u] : t[Ce(a)], r
  }
      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (e, t) {
            ...
            return _ = Math.max(Math.min(s[u] - p, _), 0), e.arrowElement = i, e.offsets.arrow = (ge(n = {}, f, Math.round(_)), ge(n, h, ""), n), e
          },
          element: "[x-arrow]"
        },
        flip: {
          ...
          fn: function (p, g) {
            ...
            return b.forEach(function (e, t) {
              ...
              (s || f || d) && (p.flipped = !0, (s || f) && (v = b[t + 1]), d && (_ = "end" === (n = _) ? "start" : "start" === n ? "end" : n), p.placement = v + (_ ? "-" + _ : ""), p.offsets.popper = me({}, p.offsets.popper, Se(p.instance.popper, p.offsets.reference, p.placement)), p = Ae(p.instance.modifiers, p, "flip"))
            }), p
          },
          behavior: "flip",
          padding: 5,
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            var s, a, l, u, c, f, h, d, p, g, m, v, y, _, b, w, E = void 0 !== o ? o : t.gpuAcceleration,
              ...
              S = (s = e, a = window.devicePixelRatio < 2 || !je, u = (l = s.offsets).popper, c = l.reference, f = Math.round, h = Math.floor, d = function (e) {
                return e
            ...
            return e.attributes = me({}, O, e.attributes), e.styles = me({}, C, e.styles), e.arrowStyles = me({}, e.offsets.arrow, e.arrowStyles), e
          },
          gpuAcceleration: !0,
          x: "bottom",
          y: "right"
        ...
        value: function () {
          return function () {
            if (!this.state.isDestroyed) {
              ...
              e.offsets.reference = Te(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = Ee(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = Se(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = Ae(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
            }
          }.call(this)
        }
      }, {
  ...
  Fe.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Fe.placements = Pe, Fe.Defaults = Me;
  var We = "dropdown",
    Be = "bs.dropdown",
    Ue = "." + Be,
    Ke = ".data-api",
    ...
    tt = function () {
      ...
      return e.toggle = function () {
          ...
          if (u._clearMenus(), !t) {
            ...
            if (p(e).trigger(i), !i.isDefaultPrevented()) {
              if (!this._inNavbar) {
                ...
                var r = this._element;
                "parent" === this._config.reference ? r = e : g.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(e).addClass("position-static"), this._popper = new Fe(r, this._menu, this._getPopperConfig())
              }
              "ontouchstart" in document.documentElement && 0 === p(e).closest(".navbar-nav").length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Ye), p(e).toggleClass(Ye).trigger(p.Event(Ve.SHOWN, n))
            }
          }
        }
      }, e.show = function () {
        if (!(this._element.disabled || p(this._element).hasClass(ze) || p(this._menu).hasClass(Ye))) {
          var e = {
              relatedTarget: this._element
            },
            t = p.Event(Ve.SHOW, e),
            n = u._getParentFromElement(this._element);
          p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Ye), p(n).toggleClass(Ye).trigger(p.Event(Ve.SHOWN, e)))
        }
      }, e.hide = function () {
        if (!this._element.disabled && !p(this._element).hasClass(ze) && p(this._menu).hasClass(Ye)) {
          var e = {
            ...
            t = p.Event(Ve.HIDE, e),
            n = u._getParentFromElement(this._element);
          p(n).trigger(t), t.isDefaultPrevented() || (p(this._menu).toggleClass(Ye), p(n).toggleClass(Ye).trigger(p.Event(Ve.HIDDEN, e)))
        }
      }, e.dispose = function () {
        ...
        return e = l({}, this.constructor.Default, p(this._element).data(), e), g.typeCheckConfig(We, e, this.constructor.DefaultType), e
        ...
        if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
          for (var t = [].slice.call(document.querySelectorAll(Ge)), n = 0, i = t.length; n < i; n++) {
            ...
            if (e && "click" === e.type && (s.clickEvent = e), o) {
              var a = o._menu;
              if (p(r).hasClass(Ye) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
                var l = p.Event(Ve.HIDE, s);
                p(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), p(a).removeClass(Ye), p(r).removeClass(Ye).trigger(p.Event(Ve.HIDDEN, s)))
              }
            }
          }
        ...
        if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(Je).length)) : Qe.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(ze))) {
  ...
  p(document).on(Ve.KEYDOWN_DATA_API, Ge, tt._dataApiKeydownHandler).on(Ve.KEYDOWN_DATA_API, Je, tt._dataApiKeydownHandler).on(Ve.CLICK_DATA_API + " " + Ve.KEYUP_DATA_API, tt._clearMenus).on(Ve.CLICK_DATA_API, Ge, function (e) {
    e.preventDefault(), e.stopPropagation(), tt._jQueryInterface.call(p(this), "toggle")
  }).on(Ve.CLICK_DATA_API, ".dropdown form", function (e) {
    e.stopPropagation()
  }), p.fn[We] = tt._jQueryInterface, p.fn[We].Constructor = tt, p.fn[We].noConflict = function () {
    ...
    Ht = function () {
      ...
      return e.enable = function () {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          p(r).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(r).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Fe(this.element, r, {
            placement: a,
            modifiers: {
              offset: this._getOffset(),
              flip: {
  ...
  p.fn[_t] = Ht._jQueryInterface, p.fn[_t].Constructor = Ht, p.fn[_t].noConflict = function () {
  ...
  p.fn[Pt] = $t._jQueryInterface, p.fn[Pt].Constructor = $t, p.fn[Pt].noConflict = function () {
  ...
  var Qt = "scrollspy",
    ...
    on = function () {
      ...
      return e.refresh = function () {
        ...
        p.removeData(this._element, Vt), p(this._scrollElement).off(zt), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
      }, e._getConfig = function (e) {
        if ("string" != typeof (e = l({}, Xt, "object" == typeof e && e ? e : {})).target) {
          var t = p(e.target).attr("id");
          t || (t = g.getUID(Qt), p(e.target).attr("id", t)), e.target = "#" + t
        }
        ...
        return this.each(function () {
          ...
          if (e || (e = new n(this, "object" == typeof t && t), p(this).data(Vt, e)), "string" == typeof t) {
            if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
            e[t]()
          }
        })
  ...
  }), p.fn[Qt] = on._jQueryInterface, p.fn[Qt].Constructor = on, p.fn[Qt].noConflict = function () {
  ...
  var pn = "toast",
    ...
    Tn = function () {
      ...
      return e.show = function () {
        ...
        return e = l({}, En, p(this._element).data(), "object" == typeof e && e ? e : {}), g.typeCheckConfig(pn, e, this.constructor.DefaultType), e
      }, e._setListeners = function () {
        var e = this;
  ...
  p.fn[pn] = Tn._jQueryInterface, p.fn[pn].Constructor = Tn, p.fn[pn].noConflict = function () {
    ...
    }(), e.Util = g, e.Alert = c, e.Button = w, e.Carousel = H, e.Collapse = z, e.Dropdown = tt, e.Modal = pt, e.Popover = $t, e.Scrollspy = on, e.Tab = dn, e.Toast = Tn, e.Tooltip = Ht, Object.defineProperty(e, "__esModule", {
      value: !0
    })
});

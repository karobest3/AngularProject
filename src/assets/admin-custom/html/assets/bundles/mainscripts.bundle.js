...
$(function () {
  ...
  skinChanger(), initSparkline(), setTimeout(function () {
    ...
    $(this).width() < 1201 ? $("body.box_layout").removeClass("h-menu") : $("body.box_layout").addClass("h-menu")
  }).trigger("resize");
  var e = function () {
...
! function () {
  ...
  e.async = !0, e.src = "https://embed.tawk.to/5e44175da89cda5a188591ec/default", e.charset = "UTF-8", e.setAttribute("crossorigin", "*"), t.parentNode.insertBefore(e, t)
